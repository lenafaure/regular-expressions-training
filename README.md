...
// Search for a string an replace that string by a literal string or a replacement string generated by a callback function
string.replace(r, string or function);
```
...
```javascript
/* replace unicorns by cupcakes */
var s9 = "unicorns and rainbows";
var replacement = s9.replace(/unicorns/, "cupcakes");
console.log(replacement); // "cupcakes and rainbows"

/* replace any sequence of word character that is between 6 and 8 characters with kittens*/
var s10 = "unicorns and rainbows and cupcakes";
var replacement2 = s10.replace(/\w{6,8}/g, "kittens");
console.log(replacement2); // "kittens and kittens and kittens"

/* double every vowel */
var s11 = "unicorns and rainbows and cupcakes";
var replacement3 = s10.replace(/([aeiou])/g, "$1$1");
console.log(replacement3); // "uuniicoorns aand raaiinboows aand cuupcaakees"

/* callback function that replaces 3-characters words with uppercase version */
var r9 = /\b\w+\b/g;
s11.replace(r9, replacer); // "unicorns" "AND" "rainbows" "AND" "cupcakes"
